...
public class RigaLavoro implements IPersistentModel{
	public RigaLavoro() {
	}
	...
	public RigaLavoro(int id, coedil99.persistentModel.Geometria g, boolean c, String pc, String note, int n) {
