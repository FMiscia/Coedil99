...
public class HistoryFactory {
	...
	public static History loadHistoryByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (History) session.load(coedil99.persistentModel.History.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static History getHistoryByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (History) session.get(coedil99.persistentModel.History.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static History loadHistoryByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (History) session.load(coedil99.persistentModel.History.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static History getHistoryByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (History) session.get(coedil99.persistentModel.History.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
