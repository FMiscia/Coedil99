...
import org.orm.*;
public class Ordine implements IPersistentModel{
	public Ordine() {
	}
	...
	public boolean deleteAndDissociate()throws PersistentException {
		try {
			...
			coedil99.persistentModel.Commessa[] lCommesses = commesse.toArray();
	...
	private java.util.List this_getList (int key) {
		if (key == coedil99.persistentModel.ORMConstants.KEY_ORDINE_COMMESSE) {
			return ORM_commesse;
		}
	...
	private void this_setOwner(Object owner, int key) {
		if (key == coedil99.persistentModel.ORMConstants.KEY_ORDINE_CLIENTE) {
			this.cliente = (coedil99.persistentModel.Cliente) owner;
		}
	}
	 ...
	 */
	private void setORM_Cliente(coedil99.persistentModel.Cliente value) {
		this.cliente = value;
	}
	
	private coedil99.persistentModel.Cliente getORM_Cliente() {
		return cliente;
	}
