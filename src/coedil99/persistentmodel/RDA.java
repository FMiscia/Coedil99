...
import org.orm.*;
public class RDA implements coedil99.persistentmodel.IPersistentModel {
	public RDA() {
	}
	...
	public boolean deleteAndDissociate()throws PersistentException {
		try {
			coedil99.persistentmodel.RigaRDA[] lRigheRDAs = righeRDA.toArray();
	...
	private java.util.List this_getList (int key) {
		if (key == coedil99.persistentmodel.ORMConstants.KEY_RDA_RIGHERDA) {
			return ORM_righeRDA;
		}
	...
	public final coedil99.persistentmodel.RigaRDAListCollection righeRDA = new coedil99.persistentmodel.RigaRDAListCollection(this, _ormAdapter, coedil99.persistentmodel.ORMConstants.KEY_RDA_RIGHERDA, coedil99.persistentmodel.ORMConstants.KEY_RIGARDA_RDA, coedil99.persistentmodel.ORMConstants.KEY_MUL_ONE_TO_MANY);
