...
public class ProductDescriptionSetCollection extends org.orm.util.ORMSet {
	public ProductDescriptionSetCollection(Object owner, org.orm.util.ORMAdapter adapter, int ownerKey, int targetKey, int collType) {
		super(owner, adapter, ownerKey, targetKey, true, collType);
	}
	
	public ProductDescriptionSetCollection(Object owner, org.orm.util.ORMAdapter adapter, int ownerKey, int collType) {
	...
	*/
	...
	protected PersistentManager getPersistentManager() throws PersistentException {
		return coedil99.persistentmodel.Coedil99ingdelsoftwarePersistentManager.instance();
	}
